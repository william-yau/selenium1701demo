...
public class GoToEdit {
  ...
  public  void A2_edit()throws InterruptedException{
        ...
        Thread.sleep(5000);
        //点击编辑
        driver.findElement(By.xpath(".//*[@id='contactList']/tbody/tr[1]/td[8]/a[3]")).click();
        Thread.sleep(5000);
        //随机时间戳
        String time=String.valueOf(System.currentTimeMillis()/100);
        //添加部门,职位
        driver.findElement(By.name("dept")).sendKeys(time);
        Thread.sleep(1000);
        driver.findElement(By.name("title")).sendKeys(time);
        //save
